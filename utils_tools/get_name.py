...
def filter_messages(input_data: List[Dict[str, str]], max_length: int) -> List[Dict[str, str]]:
    """
...
def main():
    ...
    parser.add_argument("--output", default="outname.json",
                        help="输出JSON文件路径，默认为outname.json")
